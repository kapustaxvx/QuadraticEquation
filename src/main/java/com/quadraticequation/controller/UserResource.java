...
import com.quadraticequation.model.dto.RoleToUserRequest;
...
public class UserResource {
    ...
    public ResponseEntity<?> addRoleToUser(@RequestBody RoleToUserRequest roleToUserRequest){
        userService.addRoleToUser(roleToUserRequest.getUserName(), roleToUserRequest.getRole());
        return ok().build();
    }
    ...
    public void refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(authorizationHeader != null && authorizationHeader.startsWith("Bearer ")){
            ...
            throw new RuntimeException("Refresh token отсуствует");
        }
    }
}
